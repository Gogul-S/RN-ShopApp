...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case UPDATE_PRODUCT:
            const productIndex = state.userProducts.findIndex(product => action.productId === product.id)
            ...
            const availableProductsIndex = state.availableProducts.findIndex(product => action.productId === product.id)
